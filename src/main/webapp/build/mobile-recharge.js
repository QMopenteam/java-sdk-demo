...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/mayousheng/project/git/sdk-demo/src/main/webapp/static/mobileRecharge/app.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-68f5f008&file=app.vue&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-68f5f008&file=app.vue&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextControl = __webpack_require__(8);
	...
	_vue2.default.directive('mobile-input', {
	  twoWay: true,
	  bind: function bind() {
	    this.el.setAttribute('maxLength', 11);
	    this.el.setAttribute('autocomplete', false);
	...
	exports.default = {
	  ...
	  computed: {
	    validateNo: function validateNo() {
	      return (/^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/.test(this.mobileNo.replace(/\s/g, ''))
	      );
	    },
	  ...
	  methods: {
	    selectCharge: function selectCharge(value) {
	      this.rechargeAmount = value;
	    },
	    reset: function reset(number) {
	      ...
	      this.$nextTick(function () {
	        _this.mobileNo = number;
	      });
	    },
	    sync: function sync(number) {
	      this.aliasNumber = number;
	    },
	    removeFormStatus: function removeFormStatus() {
	      if (this.formClasses.indexOf('has-error') > -1 || this.formClasses.indexOf('has-success') > -1) {
	        this.formClasses.splice(2);
	      }
	    },
	    send: function send(number) {
	  ...
	  components: {
	    TextControl: _TextControl2.default
	  }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/mayousheng/project/git/sdk-demo/src/main/webapp/static/components/TextControl.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-430e84e4&file=TextControl.vue&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./TextControl.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-430e84e4&file=TextControl.vue&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./TextControl.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.label[_v-430e84e4]{\n  cursor: pointer;\n  padding:6px 12px;\n}\n.label-bordered[_v-430e84e4]{\n  background-color: #fff;\n  color:#777;\n  border:1px solid #ccc;\n}\n.label-bordered.active[_v-430e84e4]{\n  border-color:#F60;\n}\n", "", {"version":3,"sources":["/./static/components/TextControl.vue?f0aec906"],"names":[],"mappings":";AAMA;EACA,gBAAA;EACA,iBAAA;CACA;AACA;EACA,uBAAA;EACA,WAAA;EACA,sBAAA;CACA;AACA;EACA,kBAAA;CACA","file":"TextControl.vue","sourcesContent":["<template>\n<span v-bind:class=\"classes\" @click=\"_clickHandle\">\n  <slot></slot>\n</span>\n</template>\n<style scoped>\n.label{\n  cursor: pointer;\n  padding:6px 12px;\n}\n.label-bordered{\n  background-color: #fff;\n  color:#777;\n  border:1px solid #ccc;\n}\n.label-bordered.active{\n  border-color:#F60;\n}\n</style>\n<script>\nexport default{\n  props:{\n    isActive:{\n      type:Boolean,\n      default:false\n    },\n    value:{\n      type:Number,\n      required:true\n    },\n    clickHandle:{\n      type:Function\n    }\n  },\n  data(){\n    return {\n      classes:['label','label-default','label-bordered'],\n      active:false\n    }\n  },\n  watch:{\n    isActive(isActive){\n      if(isActive){\n        this.classes.push(\"active\");\n      }else{\n        this.classes.splice(3);\n      }\n    }\n  },\n  methods:{\n    _clickHandle(){\n      this.clickHandle(this.value);\n    }\n  }\n}\n</script>\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<span v-bind:class=\"classes\" @click=\"_clickHandle\" _v-430e84e4=\"\">\n  <slot _v-430e84e4=\"\"></slot>\n</span>\n";

/***/ },
/* 13 */
/***/ function(module, exports) {

	module.exports = "\n<div class=\"container\" _v-68f5f008=\"\">\n  <form v-bind:class=\"formClasses\" method=\"post\" action=\"/mobile/itemInfo\" _v-68f5f008=\"\">\n    <div class=\"form-group\" _v-68f5f008=\"\">\n      <label for=\"mobile\" class=\"col-sm-2 control-label\" _v-68f5f008=\"\">手机号码：</label>\n       <div class=\"col-sm-10\" _v-68f5f008=\"\">\n         <div _v-68f5f008=\"\">\n            <input v-mobile-input=\"mobileNo\" v-model=\"mobileNo\" id=\"mobileNo\" name=\"mobileNo\" type=\"text\" placeholder=\"请输入手机号码\" class=\"form-control\" _v-68f5f008=\"\">\n            <span class=\"glyphicon glyphicon-ok form-control-feedback\" aria-hidden=\"true\" _v-68f5f008=\"\"></span>\n            <span class=\"glyphicon glyphicon-remove form-control-feedback\" aria-hidden=\"true\" _v-68f5f008=\"\"></span>\n         </div>\n        <div _v-68f5f008=\"\">\n            <h4 class=\"orange\" _v-68f5f008=\"\">{{aliasNumber}}</h4>\n        </div>\n       </div>\n    </div>\n    <div class=\"form-group\" _v-68f5f008=\"\">\n      <label class=\"col-sm-2 control-label\" _v-68f5f008=\"\"> 输入面值：</label>\n      <div class=\"col-sm-10\" _v-68f5f008=\"\">\n        <input type=\"number\" v-model=\"rechargeAmount\" name=\"rechargeAmount\" class=\"form-control\" placeholder=\"10，20，30\" _v-68f5f008=\"\">\n          <!--<div>\n              <ul class=\"list-inline\">\n                <li v-for='val in charges'>\n                  <text-control\n                    v-bind:click-handle=\"selectCharge\"\n                    v-bind:value=\"val\"\n                    v-bind:is-active=\"val === charge\">\n                    {{val}}</text-control>\n                </li>\n\n              </ul>\n\n          </div>-->\n      </div>\n    </div>\n    <div class=\"form-group\" _v-68f5f008=\"\">\n      <div class=\"col-sm-offset-2 col-sm-10\" _v-68f5f008=\"\">\n        <button type=\"submit\" class=\"btn btn-info\" _v-68f5f008=\"\">提交</button>\n      </div>\n    </div>\n  </form>\n</div>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultClient = __webpack_require__(26);
